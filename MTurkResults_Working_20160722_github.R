...
for (g in c(1:length(goldFiles))){print(g)
  ...
  #Don't use teeth that are way off in the averages.  
  ...
  if (dim(all)[2]>2){
    ...
    #Don't include Juliet here you moron!!
...
##########Now use average shapes WIHTOUT Juliet
#Define landmarks
...
##########Now use average shapes WITH Juliet
#Define landmarks
